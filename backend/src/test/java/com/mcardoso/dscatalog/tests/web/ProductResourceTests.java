package com.mcardoso.dscatalog.tests.web;
...
public class ProductResourceTests {
    ...
    void setUp() throws Exception {
        ...
        invalidProductDTO = ProductFactory.createProductDTO();
        ...
        when(service.insert(any())).thenReturn(invalidProductDTO);
    ...
    public void insertShouldReturnUnprocessableEntityWhenNegativePrice() throws Exception {
        ...
        invalidProductDTO.setPrice(-25.50);
    ...
    @Test
    public void insertShouldReturnCreatedAndProductWhenDataIsValid() throws Exception {
        String accessToken = obtainAccessToken(operatorUsername, operatorPassword);
